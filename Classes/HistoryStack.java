...
public class HistoryStack {
    ...
    /**
     * Pushes a new transaction frame onto the top of the collection.
     * Time Complexity: O(1) constant runtime insertion.
     */
    public void push(Book b, String action) {
        stack.push(new HistoryRecord(b, action));
    }
    /**
     * Exposes records for external list utilities while preserving internal structure encapsulation.
     */
    public List<HistoryRecord> getAllRecords() {
        return new ArrayList<>(stack);
    }
    /**
    * Displays log entries in chronological order by working on a temporary copy
    * of the stack, ensuring the original records remain unchanged.
    */
    public void show() {
